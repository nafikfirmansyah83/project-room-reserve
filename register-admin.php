...
<html>
	<head>
		...
		<title>Uniwara Class - Daftar Admin</title>
		<!-- Bootstrap -->
        ...
        <div class="wrapper">
            <div class="main">
                <div class="container">
                    ...
                    <div class="row my-2">
                        <div class="col-md">
                            <form action="register-admin.php" method="post" enctype="multipart/form-data">
                                <div class="mb-3">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="jabatan" id="jabatan" class="form-control" placeholder="ex : Mahasiswa" required>
                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="mb-3">
