...
<html lang="en">
    <head>
        ...
        <title>Uniwara Class - Login Koordinator</title>
    </head>
    <body>
                        ...
                        <form method="post" action="">
                            ...
                            <?php
								if(isset($_POST['login'])){
									...
									$sql = mysqli_query($koneksi, "select*from koordinator where email='$email' and password='$pass' and status='aktif'") or die(mysqli_error($koneksi));
                            ...
                            <div class="input-group mb-5 d-flex justify-content-between">
                                <div class="forgot position-absolute top-0 end-0">
                                    <small><a href="forgot-pass-user.php">Forgot Password?</a></small>
                                </div>
                            </div>
                            <div class="input-group mb-3">
                            ...
                            <div class="row">
                                <small>Don't have account? <a href="register-user.php">Sign Up</a></small>
                            </div>
                        </form>
                    </div>
                </div> 
