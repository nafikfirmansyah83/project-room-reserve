...
<html>
	<head>
		...
		<title>Uniwara Class - Lupa Password Admin</title>
		<!-- Bootstrap -->
		...
		<?php
            if(isset($_POST['tambah'])){ 
                ...
                if($cek->num_rows == 0){
                    if($pass1 == $pass2){
                    $pass = md5($pass1); 
                    $insert = $koneksi->query("UPDATE user SET password='$pass' WHERE email='$email'") or die(mysqli_error());
                        if($insert){ 
        ...
        <div class="wrapper">
            <div class="main">
                <div class="container">
                    ...
                    <div class="row my-2">
                        <div class="col-md">
                            <form action="forgot-pass-admin.php" method="post" enctype="multipart/form-data">
                                <div class="mb-3">
                                ...
                                <a href="login-admin.php" class="btn btn-danger" style="width: 100px;">Kembali</a>
